...
export const wishes: Wish[] = [
  ...
  },
  {
    ...
    message: [
      ...
      "I love you dearly. May the testimony of the spirit of God for you explode in this new year and may it mark a clear shift for you. I have a lot to say to you but let's save it for the days when knees have deep and hearts have ascended high.... Lol",
      "This is very personal, but you have earned the right to use my 'Exclusive Godcolors Description', I hope these words describes;",
      "\"Forged from the embers of hallowed antiquity. hewned from the very rocks that heralded civilization as we know it. Bud from the stems of the majesty in eternal nativity; not made of falial RNA, but born of spirit DNA! Famed as the joy of the celestial hierachy, revered in the highest cadre of immortal dynasty. Framed to texture of the heavenly flames, burning in the intensity aboves orions claims! Covenanted to statures beyond posidons fame, exalted in glory to now and forever reign. GODCOLORS!\"",
  ...
  },
  {
    ...
    message: [
      ...
      'And you shyly replied again, "This is how I used to talk."',
